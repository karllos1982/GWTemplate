...
namespace Template.ViewModel
{
    public class LocalizationTextLocalization:BaseLocalization
    {
        ...
        public string LocalizationCode_Label { get; set; }

        public string LocalizationName_Label { get; set; }

        public string LocalizationRecord_Label { get; set; }

        public string LocalizationText_Label { get; set; }

        public string SaveLocalizationButton_Label { get; set; }

        public string SaveLocalizationButton_Description { get; set; }

        public string NewLocalization_Label { get; set; }
